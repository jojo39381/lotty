                ...
                <Row style={{width:"80%", margin:"0 auto", marginTop:0}}>
                    ...
                    <Fade left>
                        <div style={{width:"100%"}}>
                            ...
                            <p style={{fontSize:"4vh", marginBottom:20, fontFamily: "Lato, sans-serif", fontWeight:"300", textAlign:"left", color:"white"}}>Build Credit.</p>
                            <form onSubmit={submit}>
                            <div class="input-group" style={{border:"1px solid black", borderRadius:5, marginTop:50}}>
...
{/*                 
                ...
                */}
                ...
                <Row>
                 <Col className="mb-sm-5 mb-md-0" sm={12} md={6} lg={6}>
                        ...
                        <div style={{display:"flex", justifyContent:"center", alignItems:"center", height:"100%"}}>
                        <div>
                        <h2 style={{fontSize:50, marginBottom:30, fontFamily: "Lato, sans-serif", fontWeight:"900", textAlign:"left",marginTop:50}}>No Fees. Ever.</h2>
                        <h3 style={{textAlign:"left"}}>Get a free checking or savings account in less than 1 minute. No minimum balance. No monthly fees. No overdraft fees.</h3>
                        </div>
                        </div>
                        </Fade>
                    </Col>
                ...
                <section style={{paddingTop:120, paddingBottom:120, backgroundColor:"#FAFAFA"}}>
                ...
                <Col className="mb-sm-5 mb-md-0" sm={12} md={6} lg={6}>
                        <Fade>
                            ...
                            <div>
                                <img src={PayrollPhone} width={"50%"} height={"50%"}></img>
                            </div>
                            </div>
                        </Fade>
                    </Col>
                    <Col className="mb-sm-5 mb-md-0" sm={12} md={6} lg={6}>
                        ...
                        <div style={{display:"flex", justifyContent:"center", alignItems:"center", height:"100%"}}>
                            <div>
                            <h2 style={{fontSize:50, marginBottom:30, fontFamily: "Lato, sans-serif", fontWeight:"900", textAlign:"left",marginTop:50}}>Free Payroll Advance.</h2>
                            <h3 style={{textAlign:"left"}}>We analyze your spending habits and income flow to give you the cash you need to get through life until your next paycheck. No credit checks. Take care of the important things first, we will take care of the rest.</h3>
                            </div>
                        </div>
                        </Fade>
                    </Col>
                ...
                <Row>
                    <Col className="mb-sm-5 mb-md-0" sm={12} md={6} lg={6}>
                        ...
                        <div style={{display:"flex", justifyContent:"center", alignItems:"center", height:"100%"}}>
                        <div>
                        <h2 style={{fontSize:50, marginBottom:30, fontFamily: "Lato, sans-serif", fontWeight:"900", textAlign:"left",marginTop:50}}>Smart money management at your fingertips.</h2>
                        <h3 style={{textAlign:"left"}}>Do you budgeting in your bank app. We show how much to set aside each month for rent, bills, etc, and provide you with a budget that would maximize savings.</h3>
                        </div>
                        </div>
                        </Fade>
                    </Col>
                ...
                <Col className="mb-sm-5 mb-md-0" sm={12} md={6} lg={6}>
                    ...
                    <Col className="mb-sm-5 mb-md-0" sm={12} md={6} lg={6}>
                        ...
                        <div style={{display:"flex", justifyContent:"center", alignItems:"center", height:"100%"}}>
                        <div>
                        <h2 style={{fontSize:50, marginBottom:30, fontFamily: "Lato, sans-serif", fontWeight:"900", textAlign:"left",marginTop:50}}>Build Credit With Your Monthly Bills</h2>
                        <h3 style={{textAlign:"left"}}>No credit or poor credit? No worries. We help you build credit by reporting your monthly reoccuring expenses to the credit bureaus free of charge.</h3>
                        </div>
                        </div>
                        </Fade>
                    </Col>
            ...
            <footer style={{padding:50, borderTop:"1px solid", marginTop:0, backgroundColor:"#0984E3"}}>
                <Row>
                    <Col className="mb-sm-5 mb-md-5" style={{textAlign:"left", marginBottom:50}} sm={12} md={6}>
                        ...
                        <p style={{marginTop:30, color:"#ffffff"}}>
                            The Attain Mastercard® Debit Card is provided by The Bancorp Bank, Member FDIC, pursuant to license by Mastercard International Incorporated. Mastercard is a registered trademark, and the circles design is a trademark of Mastercard International Incorporated. Program Management services provided by Galileo Financial Technologies, LLC. 
                        </p>
